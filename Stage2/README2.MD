...
1. **Monthly Surgery Count per Doctor**
   ...
   ```
![Example Image]
(https://github.com/UrielMangisto/DBProject_2281_3115/blob/main/Stage2/Images/Select1Proof.png)
...
2. **Doctors with Above-Average Surgeries**
   - מפרט רופאים שביצעו יותר ניתוחים מהממוצע, כולל התמחות, מספר ניתוחים וגיל ממוצע של המטופל
     ...
     GROUP BY d.DoctorID, d.FirstName, d.LastName, d.Speciality
      ...
      ```
![Example Image]
(https://github.com/UrielMangisto/DBProject_2281_3115/blob/main/Stage2/Images/Select2Proof.png)
...
3. **Patient Surgery and Medicine Details**
   ...
   ```
   ![Example Image]
(https://github.com/UrielMangisto/DBProject_2281_3115/blob/main/Stage2/Images/Select3Proof.png)
...
4. **Specialty Surgery and Medicine Statistics**
   ...
   ```
   ![Example Image]
(https://github.com/UrielMangisto/DBProject_2281_3115/blob/main/Stage2/Images/Select4Proof.png)
...
2. **Delete Patients without Surgeries**
   ...
   ```
   Stage2/Images/DeleteProofB2.jpg
   Stage2/Images/DeleteProofA2.jpg

### UPDATE Queries

1. **Update Medicine Dosage**
   - עדכון מינון התרופות המשמשות בניתוחים המבוצעים על ידי רופאים בעלי תפקיד ספציפי למינון הממוצע של אותן תרופות.
   ```sql
   UPDATE Medicine m
   SET m.Dosage = (
