...
2. **שילוב טבלאות המטופלים (Patient1 ו-Patients)**:
   איחדנו את טבלאות המטופלים כדי ליצור מאגר מידע אחד ומקיף על כל המטופלים. הוספנו שדות חדשים כמו 'Gender''Contact Information', ' Insurance ', , שהיו חסרים במערכת המקורית. זה מאפשר ניהול טוב יותר של פרטי המטופל ומשפר את היכולת לתקשר עמם ולנהל את הטיפול הרפואי שלהם.
במערכת המקורית היו לנו תכונות של FIRST Name, Last Name. במערכת שקיבלנו מהם היה Full Name. במערכת המשולבת דאגנו לכך שהתכונה תהיה Full Name, כלומר איחדנו את FIRST NAME ו-Last NAME לתכונה אחת.
...
3. **שילוב טבלאות הרופאים (Doctor1 ו-Doctors)**:
   ...
   בנוסף איחדנו את המידע שלנו לגבי שמות כך שנכיל עמודה שתכיל שם מלא בדומה לטבלה של המידע הנכנס(Full Name  בלבד בדומה לסעיף 2)

5. **הוספת טבלת Appointment**:
   הוספנו טבלת פגישות חדשה שמאפשרת מעקב אחר כל הפגישות המתוכננות. זה מייעל את תהליך תזמון הפגישות ומאפשר ניצול טוב יותר של משאבי בית החולים.
...
8. **שינויים במבנה הנתונים**:
   ביצענו מספר שינויים במבנה הנתונים, כגון איחוד שדות השם הפרטי ושם המשפחה לשדה שם מלא אחד. זה נעשה כדי להתאים את המידע שלנו עם המידע של המערכת שקיבלנו.

9. **טיפול בערכים חסרים חדשים**:
   עבור שדות חדשים שהוספנו, אפשרנו ערכי NULL או הגדרנו ערכי ברירת מחדל כמו 'Unknown'. זה מאפשר לנו לשמור על שלמות הנתונים תוך כדי ציון ברור של מידע חסר. טיפלנו כך בשדות חדשים שנכנסו כמו 'Gender', 'Insurance', 'Contact Information'.

10. **טיפול בערכים חסרים קיימים**:
   עבור שדות קיימים שאינם מופיעים במערכת השנייה, אפשרנו ערכי NULL או הגדרנו ערכי ברירת מחדל כמו 'Unknown'. זה מאפשר לנו לשמור על שלמות הנתונים תוך כדי ציון ברור של מידע חסר. כך לדוג' ביצענו עבור 'Position' של טבלת Doctor שבמערכת שלהם התכונה אינה קימת.
